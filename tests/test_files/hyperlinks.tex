...
\chapter{Hyperlinks}\label{ch:Hyperlinks}

The world's go to when it comes to search engine is \href{www.google.com}{Google}. But a few people uses the \href{www.bing.com}{Bing}.
\end{document}
