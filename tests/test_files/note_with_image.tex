...
\chapter{Note With Image}\label{ch:Note With Image}

\section{My note with images}

Here is a screenshot of the repo's \inlinecode[bgcolor=LightGray, fontsize=\scriptsize]{README}:

\begin{figure}[H]\centering
	\includegraphics[width=1.2\linewidth]{"test_files/repo_img.png"}
\end{figure}
\end{document}
