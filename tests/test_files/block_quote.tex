...
- Creating \inlinecode[bgcolor=LightGray, fontsize=\scriptsize]{something} new

- Adding functionalities to \inlinecode[bgcolor=LightGray, fontsize=\scriptsize]{obsidian_pdf}
\end{tcolorbox}
