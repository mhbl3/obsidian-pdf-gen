...
\renewcommand{\subsubsection}{\textcolor{yellow}{#1}}\mbox{}\\}
\newcommand{\myparagraph}[1]{\paragraph{\textcolor{Green}{#1}}\mbox{}\\}
\newcommand{\mysubparagraph}[1]{\subparagraph{\textcolor{blue}{#1}}\mbox{}\\}
\begin{document}


\chapter{Colorful Headers}\label{ch:Colorful Headers}
...
\noindent\myparagraph{H4}

colorful

\noindent\mysubparagraph{H5}
